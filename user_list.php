            ...
            <div class="content_section_settings">
                ...
                <div class="settingsContainer">
                    <div class="settingsNav">
                        ...
                        <a id="SettigsNav_active" href="user_list.php">Manage Members</a>
                        <a href="">Approve Members</a>
                    </div>

                    <div class="editProTop ">
                        <h1 class="userlist-Title" style="color: #2F2E41;font-size: 40px;">User Management</h1> 
                    </div>

                    <div class="editProBottom userlist">
                        <table>
                            <thead>
                                <tr>
                                    <th>Name</th>
